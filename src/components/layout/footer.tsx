    ...
    <footer className={styles.footer}>
      <div className={styles.grid}>
        <div className={styles.column}>
          ...
          <p className={styles.aboutText}>
            Ексклюзивні продукти з Європи для вашого столу. Селекція преміум
            якості.
          </p>
        </div>

        <nav className={styles.column}>
          <h2 className={styles.columnTitle}>Навігація</h2>
        ...
        <nav className={styles.column}>
          <h2 className={styles.columnTitle}>Інформація</h2>
        ...
        <div className={styles.column}>
          <h2 className={styles.columnTitle}>Контакти</h2>
          <a href="mailto:oljacenuk88@gmail.com" className={styles.link}>
      ...
      <div className={styles.bottomBarWrapper}>
        <div className={styles.bottomBar}>
          ...
          <p className={styles.designer}>DESIGNED BY VLADYSLAV</p>
        </div>
      </div>
    </footer>
  );
