...
const CATEGORY_SLUG_HELP =
  "Натисніть «Generate», щоб створити посилання з назви; після зміни назви згенеруйте slug знову за потреби. На сайті: ваш-домен/catalog?category=ваш-slug. Дублікати URL між категоріями заборонені. Після публікації змінюйте slug лише з обережності.";
...
export const category = defineType({
  ...
  fields: [
    defineField({
      ...
      title: "Назва",
      description:
        "Відображається в меню каталогу та на сторінці розділу. Обовʼязкове поле.",
      group: "basics",
